...
from ..serializers import CustomizeThemeDesignOrderListSerializer  # Assuming you have a serializer for OrderList model
from django.http import JsonResponse

class CustomizeThemeDesignOrderView(APIView):
    def post(self, request):
        serializer = CustomizeThemeDesignOrderListSerializer(data=request.data)
