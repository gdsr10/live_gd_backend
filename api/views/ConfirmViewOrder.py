...
class ConfirmViewOrderview(APIView):
    def post(self, request):
        ...
        pending_orders = OrderList.objects.filter(customername=first_name, status='0').values()
        ...
        return JsonResponse({'message': 'Confirm Order data retreived successfully', 'status': 200, 'success': True, 'data': pending_orders_list}, status=200)
