...
from ..serializers import CustomizeThemeDesignMensOrderListSerializer  # Assuming you have a serializer for OrderList model
from django.http import JsonResponse

class CustomizeThemeDesignMenOrderView(APIView):
    def post(self, request):
        serializer = CustomizeThemeDesignMensOrderListSerializer(data=request.data)
